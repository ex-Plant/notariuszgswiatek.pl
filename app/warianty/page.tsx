  ...
  return (
    <main className="min-h-dvh bg-[#F8F6F1] text-zinc-950 flex-1 flex flex-col">
      <header className="max-w-[1400px] mx-auto px-6 md:px-12 pt-16 md:pt-24 pb-12 w-full">
        <Link
          href="/"
          className="inline-flex items-center gap-2 text-xs font-mono uppercase tracking-[0.22em] text-zinc-500 hover:text-zinc-950 transition-colors"
        >
          <ArrowLeft size={12} weight="bold" /> Strona główna
        </Link>
        <p className="mt-10 font-mono text-xs uppercase tracking-[0.22em] text-zinc-500">
          Warianty wizualne · maj 2026
        </p>
